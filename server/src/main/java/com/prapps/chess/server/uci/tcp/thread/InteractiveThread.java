...
import com.prapps.chess.server.AdminServer;
//import com.prapps.chess.server.EngineServer;
import com.prapps.chess.server.Server;
...
public class InteractiveThread extends AbstractRunnable {
	...
	private ServerLoader serverConfig;
	private AdminServer adminServer;

	public InteractiveThread(int port, AdminServer adminServer, ServerLoader serverConfig) throws IOException {
